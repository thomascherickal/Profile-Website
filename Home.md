...
| :--- | :--- | :--- |
| 🦀 **[slm-inference-engine](https://github.com/thomascherickal/slm-inference-engine)** | `Rust` `Local AI` `Upcoming` | High-performance Rust library for local SLM inference on CPU-only hardware. Optimized for 2–8 GB RAM targets with streaming support. |
| 🐍 **[ai-career-toolkit](https://github.com/thomascherickal/ai-career-toolkit)** | `Python` `GenAI` `Upcoming` | Python scripts, prompts, and automation tools accompanying the *RECRUITED* book — NotebookLM workflows, resume AI analysis, LinkedIn audit scripts. |
| ⚛️ **[quantum-ai-experiments](https://github.com/thomascherickal/quantum-ai-experiments)** | `Python` `QAI` `Upcoming` | Research notebooks exploring QAI intersections — Qiskit, Q#, Quantinuum stack experiments, and quantum threat modeling for blockchain systems. |
| 🌐 **[digital-futurist-site](https://github.com/thomascherickal/thomascherickal.github.io)** | `HTML/CSS` `SEO` `Open Source` | Open-source GitHub Pages site with JSON-LD schema, SEO metadata, dark-mode design, and cross-platform social integration. |
| 🦀 **[rust-llm-router](https://github.com/thomascherickal/rust-llm-router)** | `Rust` `LLM Infra` `Upcoming` | Zero-latency request router for multi-provider LLM APIs with automatic failover, rate-limit awareness, and cost-optimized model selection across OpenRouter, Ollama, and LM Studio. |
| 🦀 **[vector-forge](https://github.com/thomascherickal/vector-forge)** | `Rust` `Vector DB` `Upcoming` | High-performance SIMD-accelerated vector operations library for embedding pipelines — cosine similarity, HNSW indexing, and ANN search at native speed for RAG workloads. |
...
<details>
<summary><b>View slm_agent.rs (Rust)</b></summary>
...
<details>
<summary><b>View llm_bench.py (Python)</b></summary>
...
🔗 **Read more on:** [HackerNoon](https://hackernoon.com/u/thomascherickal) · [Medium](https://thomascherickal.medium.com) · [Substack](https://thesingularitypoint.substack.com)
...
* **Patreon Support:** [Pre-Order on Patreon](https://www.patreon.com/thomascherickal) *(New Digital Products Released Every Week)*
...
*   🎗 **Exclusive Member Content:** [patreon.com/thomascherickal](https://www.patreon.com/thomascherickal)
...
© 2026 Thomas Cherickal · The Digital Futurist · thomascherickal.com
